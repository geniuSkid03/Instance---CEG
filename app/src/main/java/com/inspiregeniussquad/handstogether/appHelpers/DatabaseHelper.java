...
public class DatabaseHelper {
    ...
    private static final int MAX_UPLOAD_RETRY_MILLIS = 60000;
...
//        Sets the maximum time to retry upload operations if a failure occurs.
    ...
    public void closeListener(ValueEventListener listener) {
        if (activeListeners.containsKey(listener)) {
            ...
            AppHelper.print("closeListener(), listener was removed: " + listener);
        } else {
            AppHelper.print("closeListener(), listener not found :" + listener);
        }
    }
