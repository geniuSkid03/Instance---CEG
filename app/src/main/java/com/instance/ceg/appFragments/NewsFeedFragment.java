...
import com.instance.ceg.appActivities.CommentsViewActivity;
import com.instance.ceg.appActivities.NewsItemViewActivity;
import com.instance.ceg.appActivities.PosterViewActivity;
import com.instance.ceg.appAdapters.NewsFeedAdapter;
...
//        goTo(getContext(), PosterViewActivity.class, false,  Keys.NEWS_ITEM, gson.toJson(newsFeedItems));
    ...
    public void refreshNewsFeed() {
        ...
        new DbHelper().getAllNews(new DbHelper.NewsRetrieveCallback() {
            @Override
    ...
    private void retriveDataFromDb(DataSnapshot dataSnapshot) {
        ...
        for (Map.Entry<String, NewsFeedItems> teamEntry : newsFeedItemsMap.entrySet()) {
            ...
            newsFeedItems.setTimeStamp((long) map.get("timeStamp"));
...
//
        ...
        /*for(NewsFeedItems items : newsFeedItemsArrayList) {
            ...
            AppHelper.print("Items: "+items.geteName()+"\tTimeStamp: "+timestamp);
        }*/

//        Collections.sort(newsFeedItemsArrayList, (newsFeedItems, t1) ->
//                Long.compare(newsFeedItems.getTimeStamp(), t1.getTimeStamp()));
