...
public class CulturalsFragment extends SuperFragment {
    ...
    protected View inflateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return initView(inflater.inflate(R.layout.fragment_culturals, container, false));
    }
    ...
    public void refreshCulturalsTeams() {
