...
public class AddTeamMembersActivity_ViewBinding implements Unbinder {
  ...
  public AddTeamMembersActivity_ViewBinding(final AddTeamMembersActivity target, View source) {
    ...
    target.teamMemberPositionSpinner = Utils.findRequiredViewAsType(source, R.id.member_position_spinner, "field 'teamMemberPositionSpinner'", AppCompatSpinner.class);
  ...
  public void unbind() {
    ...
    target.teamMemberPositionSpinner = null;
