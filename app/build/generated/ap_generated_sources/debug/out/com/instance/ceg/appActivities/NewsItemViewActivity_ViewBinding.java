...
public class NewsItemViewActivity_ViewBinding implements Unbinder {
  ...
  public NewsItemViewActivity_ViewBinding(NewsItemViewActivity target, View source) {
    ...
    target.bookmarkFab = Utils.findRequiredViewAsType(source, R.id.bookmark_fab, "field 'bookmarkFab'", AppCompatButton.class);
    target.shareFab = Utils.findRequiredViewAsType(source, R.id.share_fab, "field 'shareFab'", AppCompatButton.class);
    target.venueTv = Utils.findRequiredViewAsType(source, R.id.venue_tv, "field 'venueTv'", TextView.class);
  }
